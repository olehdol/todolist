...
j;odsl;hjdoh
        ...
        if days_left == 0:
            ...
            return self.title + " (Yesterday)"  # Annotate as Yesterday
        elif days_left > 1:
    ...
    if len(items) > 0:
        ...
        for index, item in enumerate(items):
            ...
            if '(' in item_str:
                ...
                date = maybe_color_str(date, due_color, lambda: True if "ago" in date else False) # Support for Past-Due Stuffs
